...
const uint64_t FORGING_TEAM_REWARD = 9'890'000 MHC;
const uint64_t FORGING_FOUNDER_REWARD = 92'000'000 MHC;
const uint64_t FORGING_DAILY_LIMIT_UP = 20'930'000 MHC;
